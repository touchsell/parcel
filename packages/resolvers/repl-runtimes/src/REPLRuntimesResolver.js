...
const FILES = new Map([
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/bundle-manifest.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/bundle-url.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/cacheLoader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/get-worker-url.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/relative-path.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/browser/preload-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname +
        '/../../../runtimes/js/src/loaders/browser/prefetch-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/browser/css-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/browser/html-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/browser/js-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/browser/wasm-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname +
        '/../../../runtimes/js/src/loaders/browser/import-polyfill.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/worker/js-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/worker/wasm-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/node/css-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/node/html-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/node/js-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../runtimes/js/src/loaders/node/wasm-loader.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname + '/../../../transformers/js/src/esmodule-helpers.js',
      'utf8',
    ),
  ],
  [
    ...
    fs.readFileSync(
      __dirname +
        '/../../../transformers/react-refresh-wrap/src/helpers/helpers.js',
      'utf8',
    ),
  ],
]);
